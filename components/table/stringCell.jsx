export default class StringCell extends React.Component {
    ...
    render() {
       ...
       let titleCell = (typeof item ==="object" && item !==null) ?<a title={item.Title} target={this.props.openTab?"_blank":"_self"} href={item.Href}><span>{item.Title}</span></a>:<span title={item}>{item}</span>;
